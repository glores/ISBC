...
public class RecomendadorVivienda implements StandardCBRApplication {
	...
	public void cycle(CBRQuery query) throws ExecutionException {
		...
		// simConfig.addMapping(new
		// Attribute("HolidayType",DescripcionVivienda.class), new Equal());
		// simConfig.addMapping(new Attribute("NumberOfPersons",
		// DescripcionVivienda.class), new Interval(12));
		// simConfig.addMapping(new
		// Attribute("Region",DescripcionVivienda.class), new Equal());
		// simConfig.addMapping(new
		// Attribute("Transportation",DescripcionVivienda.class), new Equal());
		// simConfig.addMapping(new
		// Attribute("Duration",DescripcionVivienda.class), new Interval(21));
		// simConfig.addMapping(new
		// Attribute("Season",DescripcionVivienda.class), new Equal());
		// simConfig.addMapping(new
		// Attribute("Accommodation",DescripcionVivienda.class), new Equal());
		//
		// // Es posible modificar el peso de cada atributo en la media
		// ponderada.
		// // Por defecto el peso es 1.
		// // simConfig.setWeight(new Attribute("Season",
		// TravelDescription.class), 0.5);
		//
		...
		//
		// // Imprimimos el resultado del k-NN y obtenemos la lista de casos
		// recuperados
