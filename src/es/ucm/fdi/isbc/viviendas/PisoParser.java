...
/**
 * Clase encargada de analizar los archivos html y generar una representación adecuada de la información
 * @author Juan A. Recio
...
public class PisoParser {
	...
	public void parse(String file)
	{
		try {
			...
			if(cad.equals("Ático")) tipo = TipoVivienda.Apartamento;
			...
			else if(cad.equals("Dúplex")) tipo = TipoVivienda.Duplex;
			else if(cad.equals("Estudio")) tipo = TipoVivienda.Estudio;
			else if(cad.equals("Finca rústica")) tipo = TipoVivienda.Fincarustica;
			...
			vivienda.setDescripcion(cad.trim().toLowerCase().replace('\n', '.'));
	...
	public static void main(String[] args) {
		...
		try {
			...
			// TODO Cambiar la ruta a donde esté la base casos
